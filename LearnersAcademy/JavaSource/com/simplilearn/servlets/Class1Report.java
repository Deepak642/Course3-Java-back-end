...
public class Class1Report extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			List<Students> StudentList = session.createQuery("select _sub from Students _sub where _sub.class_id=1" , Students.class).getResultList();
			PrintWriter out = response.getWriter();
			out.println("List of Students from Class-1:-");
			...
			List<Subjects> subjectsList = session.createQuery("select _sub from Subjects _sub where _sub.class_id=1" , Subjects.class).getResultList();
			out.println("<br><br>List of Subjects for Class-1:-");
			...
			List<Teachers> TeacherList = session.createQuery("select _sub from Teachers _sub join Subjects _sub1 on _sub.teacher_id=_sub1.teacher_id where _sub1.class_id=1" ,Teachers.class).getResultList();
			out.println("<br><br>List of Teachers for Class-1:-");
